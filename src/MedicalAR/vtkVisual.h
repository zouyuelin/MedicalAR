...
{
public:
    VtkPose(pcl::PointCloud<pcl::PointXYZRGBA>::Ptr pts, std::string config, std::string name = "/home/guanbo/ubuntu/STL/FuQiangStl/FuQiangGanZang.stl");

    void run();
    void vtkRunner();
    void getpose(cv::Mat mMat);
    void getrgb(cv::Mat image);
    void combination();
